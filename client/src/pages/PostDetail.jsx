    ...
    <div className="max-w-3xl mx-auto">
      ...
      {editing ? (
        ...
        <article className="bg-white dark:bg-zinc-800 shadow rounded-lg p-6">
          ...
          {post.tags && post.tags.length > 0 && (
            <div className="flex flex-wrap gap-1.5 mb-4">
              {post.tags.map((tag, index) => (
                <span
                  key={index}
                  className="px-2 py-0.5 text-xs rounded-full bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300"
                >
                  {tag}
                </span>
              ))}
          ...
          {isAuthenticated && (
            <div className="pt-4 border-t border-gray-200 dark:border-zinc-700 flex justify-end space-x-2">
              <button
